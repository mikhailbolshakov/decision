...
// RqBody allows define request body if any
...
// RqBody allows pass a variable of expected response type, so that response body is unmarshalled to this variable
